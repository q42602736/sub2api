...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.POST("/auto-reauthorize/batch", h.Admin.Account.AutoReauthorizeBatch)
		accounts.GET("/auto-reauthorize/batch/:job_id", h.Admin.Account.AutoReauthorizeBatchStatus)
		...
		accounts.POST("/:id/auto-reauthorize", h.Admin.Account.AutoReauthorize)
		accounts.GET("/:id/auto-reauthorize/:job_id", h.Admin.Account.AutoReauthorizeStatus)
