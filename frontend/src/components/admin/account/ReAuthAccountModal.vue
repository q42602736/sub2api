...
const openaiLoginHint = computed(() => getOpenAIAccountLoginHint(props.account))
...
const handleGenerateUrl = async () => {
  ...
  if (isOpenAILike.value) {
    await openaiOAuth.generateAuthUrl(props.account.proxy_id, undefined, openaiLoginHint.value)
