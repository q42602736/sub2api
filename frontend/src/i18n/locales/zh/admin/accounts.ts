export default {
    accounts: {
      ...
      bulkActions: {
		...
		resetStatus: '批量重置状态',
		refreshToken: '批量刷新令牌',
		autoReauthorize: '批量自动重新授权',
		confirmAutoReauthorize: '将按顺序自动重新授权选中的 {count} 个 OpenAI OAuth 账号，过程中会共享 Mail.tm 收件箱。确定继续吗？',
		autoReauthorizeSuccess: '已成功自动重新授权 {count} 个账号',
		autoReauthorizePartial: '批量自动重新授权完成：成功 {success} 个，失败 {failed} 个',
      ...
      oauth: {
        ...
        openai: {
          ...
          autoReauthTitle: '容器内自动重新授权',
          autoReauthDesc: '使用配置好的 Mail.tm 邮箱自动获取验证码并完成授权。',
          startAutoReauth: '开始自动重新授权',
          autoReauthing: '自动授权中...',
          autoReauthFailed: '自动重新授权失败',
          autoReauthLogTitle: '自动重新授权流程日志',
          autoReauthJobId: '任务 ID',
          autoReauthRunning: '执行中',
		  autoReauthSucceeded: '授权成功',
		  autoReauthNoLogs: '暂无流程日志',
		  autoReauthBatchTitle: '批量自动重新授权流程',
		  autoReauthBatchJobId: '批量任务 ID',
		  autoReauthBatchRunning: '批量执行中',
		  autoReauthBatchSucceeded: '批量授权成功',
		  autoReauthBatchFailed: '批量授权已完成，但有账号失败',
		  autoReauthBatchProgress: '已完成 {completed}/{total} 个账号',
		  autoReauthBatchSucceededCount: '成功 {count} 个',
		  autoReauthBatchFailedCount: '失败 {count} 个',
		  autoReauthBatchCurrent: '当前处理：{name}',
		  autoReauthBatchAccountPending: '等待中',
		  autoReauthBatchAccountRunning: '授权中',
		  autoReauthBatchAccountSucceeded: '成功',
		  autoReauthBatchAccountFailed: '失败',
		  autoReauthBatchNoLogs: '暂无流程日志',
