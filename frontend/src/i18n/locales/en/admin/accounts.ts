export default {
    accounts: {
      ...
      bulkActions: {
		...
		refreshToken: 'Refresh Token',
		autoReauthorize: 'Bulk Auto Re-authorize',
		confirmAutoReauthorize: 'The selected {count} OpenAI OAuth account(s) will be re-authorized sequentially using the shared Mail.tm inbox. Continue?',
		autoReauthorizeSuccess: 'Successfully re-authorized {count} account(s) automatically',
		autoReauthorizePartial: 'Bulk automatic re-authorization finished: {success} succeeded, {failed} failed',
      ...
      oauth: {
        ...
        openai: {
          ...
          autoReauthTitle: 'Automatic container re-authorization',
          autoReauthDesc: 'Use the configured Mail.tm mailbox to receive the code and finish authorization automatically.',
          startAutoReauth: 'Start automatic re-authorization',
          autoReauthing: 'Authorizing automatically...',
          autoReauthFailed: 'Automatic re-authorization failed',
          autoReauthLogTitle: 'Automatic re-authorization logs',
          autoReauthJobId: 'Job ID',
          autoReauthRunning: 'Running',
		  autoReauthSucceeded: 'Authorization succeeded',
		  autoReauthNoLogs: 'No process logs yet',
		  autoReauthBatchTitle: 'Bulk automatic re-authorization',
		  autoReauthBatchJobId: 'Batch job ID',
		  autoReauthBatchRunning: 'Batch running',
		  autoReauthBatchSucceeded: 'Batch authorization succeeded',
		  autoReauthBatchFailed: 'Batch finished with failures',
		  autoReauthBatchProgress: '{completed}/{total} account(s) completed',
		  autoReauthBatchSucceededCount: '{count} succeeded',
		  autoReauthBatchFailedCount: '{count} failed',
		  autoReauthBatchCurrent: 'Currently processing: {name}',
		  autoReauthBatchAccountPending: 'Pending',
		  autoReauthBatchAccountRunning: 'Authorizing',
		  autoReauthBatchAccountSucceeded: 'Succeeded',
		  autoReauthBatchAccountFailed: 'Failed',
		  autoReauthBatchNoLogs: 'No process logs yet',
