export default {
    settings: {
      ...
      scheduling: {
        ...
        openaiOverLimitModeHint: 'When enabled, OpenAI /v1/responses, /v1/messages, and /v1/chat/completions accounts that hit 429 enter only a short cooldown instead of being skipped until the real upstream reset time. This lets them rejoin scheduling and potentially reuse upstream cache later.',
